...
export default function GuestClaim({
  ...
  async function handleCopyLink() {
    ...
    try {
      ...
      console.error(error);
      setCopyToast(
        "Could not copy link. Try manually copying from the address bar.",
      );
    }
  }
    ...
    return (
      <div className="guest-screen-premium">
        ...
        <Card elevated className="name-card-premium">
          <form
            className="name-card-content"
            onSubmit={handleJoin}
          >
            <label
              htmlFor="guestName"
              className="name-card-label"
            >
      ...
      <div className="claim-items-receipt">
        {tab.items.map((item, index) => {
          ...
          return (
            <motion.div
              key={item.id}
              className={`claim-item-row ${
                isClaimed ? "claimed" : ""
              } ${
                tab.status === "settled" ? "settled" : ""
              }`}
              ...
              <div className="claim-item-main">
                ...
                {isClaimed && share > 0 && (
                  <div className="your-share">
                    <span className="your-share-label">
                      Your split:
                    </span>
